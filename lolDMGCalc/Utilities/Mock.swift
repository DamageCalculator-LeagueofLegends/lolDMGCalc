...
//        ChampionModel(champion_id: 266)
        ChampionModel(
            ...
            q_bounds: Bounds(lower: 0, upper: 4),
            w_bounds: Bounds(lower: 0, upper: 4),
            e_bounds: Bounds(lower: 0, upper: 4),
            r_bounds: Bounds(lower: 0, upper: 4),
